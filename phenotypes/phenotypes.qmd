...
If packages are missing, install them following these [instructions](https://docs.hdc.ntnu.no/do-science/hunt-workbench/getting-started/5-rstudio#r-packages).

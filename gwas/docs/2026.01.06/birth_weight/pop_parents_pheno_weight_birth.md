...
Association results by regenie for weight_birth in parents, followed by simple pruning of the hits passing p < 1e-06.
Note:
- Markers with a maf < 0.01 are not annotated on the Manhattan plot.
### Manhattan
![](figures/pop_parents_pheno_weight_birth_mh.png)
### Top hits common
...
### Quality Control
- QQ plot
![](figures/pop_parents_pheno_weight_birth_qq.png)
- Beta vs. Allele Frequency
![](figures/pop_parents_pheno_weight_birth_beta_af.png)
- Standard error vs. Allele Frequency
![](figures/pop_parents_pheno_weight_birth_se_af.png)
